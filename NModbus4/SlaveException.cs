...
namespace Modbus
{
    ...
    public class SlaveException : Exception
    {
        ...
        public SlaveException(string message) : base(message)
        {
        }
        ...
        public SlaveException(string message, Exception innerException) : base(message, innerException)
        {
        }
        ...
        internal SlaveException(string message, SlaveExceptionResponse slaveExceptionResponse) : base(message)
        {
            _slaveExceptionResponse = slaveExceptionResponse;
        }
        ...
        protected SlaveException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
            if (info != null)
            {
