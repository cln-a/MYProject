namespace Modbus.Device
{
    ...
    public class ModbusUdpSlave : ModbusSlave
    {
        ...
        private ModbusUdpSlave(byte unitId, UdpClient udpClient) : base(unitId, new ModbusIpTransport(new UdpClientAdapter(udpClient)))
        {
        ...
        public static ModbusUdpSlave CreateUdp(UdpClient client)
            => new ModbusUdpSlave(Modbus.DefaultIpSlaveUnitId, client);

        /// <summary>
        ///     Modbus UDP slave factory method.
        /// </summary>
        public static ModbusUdpSlave CreateUdp(byte unitId, UdpClient client) => new ModbusUdpSlave(unitId, client);
