namespace Modbus.Device
{
    ...
    {
        internal ModbusMaster(ModbusTransport transport) : base(transport)
        {
        }
        ...
        public void ReadHoldingRegisters(ReadHoldingInputRegistersRequest request, ReadHoldingInputRegistersResponse response)
        {
            ValidateNumberOfPoints("numberOfPoints", request.NumberOfPoints, 125);
            response = Transport.UnicastMessage<ReadHoldingInputRegistersResponse>(request);
        }
