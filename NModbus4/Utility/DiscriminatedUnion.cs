namespace Modbus.Utility
{
    ...
    public class DiscriminatedUnion<TA, TB>
    {
        private TA _optionA;
        private TB _optionB;
        private DiscriminatedUnionOption _option;
        ...
        /// </summary>
        public DiscriminatedUnionOption Option => _option;
        ...
        public static DiscriminatedUnion<TA, TB> CreateA(TA a)
            => new DiscriminatedUnion<TA, TB>() { _option = DiscriminatedUnionOption.A, _optionA = a };
        ...
        public static DiscriminatedUnion<TA, TB> CreateB(TB b)
            => new DiscriminatedUnion<TA, TB>() { _option = DiscriminatedUnionOption.B, _optionB = b };
