namespace Modbus.IO
{
    ...
    public abstract class ModbusTransport : IDisposable
    {
        ...
        protected int _retries = Modbus.DefaultRetries;
        protected int _waitToRetryMilliseconds = Modbus.DefaultWaitToRetryMilliseconds;
        ...
        private static void Sleep(int millisecondsTimeout) => Thread.Sleep(millisecondsTimeout);
