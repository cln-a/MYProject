namespace Modbus
{
    ...
    {
        public static bool NeedSwap;
        public static void Init()
        {
            NeedSwap = (short)0x00ff != System.Net.IPAddress.NetworkToHostOrder((short)0x00ff);
        }
        public static void Swap(ref ushort src, ref ushort dest)
        {
            if (NeedSwap)
            {
                src = (ushort)(src ^ dest);
                dest = (ushort)(src ^ dest);
                src = (ushort)(src ^ dest);
            }
        }
